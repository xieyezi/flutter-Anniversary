              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    _buildMiddleItem(title: '分享给好友', imgUrl: 'assets/images/air.png', size: 30),
                  ],
                ),
              ),
            ),
              ...
              child: Column(
                ...
                children: <Widget>[
                  GestureDetector(
                      ...
                      child: Text('觉非 温情出品', style: AppTextStyles.aboutStyle)),
                  SizedBox(height: 8),
                  GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (_) {
                      ...
                      child: Text('隐私协议 软件使用协议 官方地址', style: AppTextStyles.aboutStyle)),
                ],
              ),
            ),
          ],
