  ...
  Widget build(BuildContext context) {
              ...
              Expanded(
                child: widget.isCancel
                    ? Container(
                        ...
                        child: FlatButton(
                          child: Text(widget.cancelContent == null ? '取消' : widget.cancelContent,
                              style: TextStyle(
                                fontSize: 14.0,
              ...
              Expanded(
                  child: Container(
                    ...
                    child: FlatButton(
                      ...
                      child: Text(widget.confirmContent == null ? '确定' : widget.confirmContent,
                          style: TextStyle(
                            fontSize: 14.0,
                            fontWeight: FontWeight.w100,
                            fontFamily: 'Dongqing',
    ...
    Column _columnImage = Column(
      children: <Widget>[
        ...
        Image(image: AssetImage(widget.image == null ? '' : widget.image), width: 72.0, height: 72.0),
        SizedBox(height: 10.0),
        Text(widget.imageHintText == null ? "" : widget.imageHintText, style: TextStyle(fontSize: 16.0)),
      ],
    );
